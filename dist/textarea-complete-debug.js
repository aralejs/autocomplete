...
define("arale/autocomplete/1.2.5/autocomplete-debug", [ "$-debug", "arale/overlay/1.1.1/overlay-debug", "arale/position/1.0.1/position-debug", "arale/iframe-shim/1.0.2/iframe-shim-debug", "arale/widget/1.1.1/widget-debug", "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "arale/templatable/0.9.1/templatable-debug", "gallery/handlebars/1.0.2/handlebars-debug", "arale/autocomplete/1.2.5/data-source-debug", "arale/autocomplete/1.2.5/filter-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Overlay = require("arale/overlay/1.1.1/overlay-debug");
    var Templatable = require("arale/templatable/0.9.1/templatable-debug");
    var DataSource = require("arale/autocomplete/1.2.5/data-source-debug");
    var Filter = require("arale/autocomplete/1.2.5/filter-debug");
    var template = require("arale/autocomplete/1.2.5/autocomplete-debug.handlebars");
...
define("arale/autocomplete/1.2.5/data-source-debug", [ "arale/base/1.1.1/base-debug", "arale/class/1.1.0/class-debug", "arale/events/1.1.0/events-debug", "$-debug" ], function(require, exports, module) {
...
define("arale/autocomplete/1.2.5/filter-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug");
    var Filter = {
...
define("arale/autocomplete/1.2.5/autocomplete-debug.handlebars", [ "gallery/handlebars/1.0.2/runtime-debug" ], function(require, exports, module) {
